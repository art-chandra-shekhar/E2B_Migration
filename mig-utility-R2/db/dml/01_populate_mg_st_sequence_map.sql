-- Populate MG_ST_SEQUENCE_MAP from source.
-- Spool: db/logs/sql/01_populate_mg_st_sequence_map.LOG (path is relative to SQL*Plus cwd;
...
-- Spool Log File
SPOOL &spool_log_dir./01_populate_mg_st_sequence_map.LOG
...
INSERT INTO MG_ST_SEQUENCE_MAP SELECT * FROM xxxx;
