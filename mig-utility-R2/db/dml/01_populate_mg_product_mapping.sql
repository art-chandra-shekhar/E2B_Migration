-- Populate MG_PRODUCT_MAPPING from source.
-- Spool: db/logs/sql/01_populate_mg_product_mapping.LOG (path is relative to SQL*Plus cwd;
...
-- Spool Log File
SPOOL &spool_log_dir./01_populate_mg_product_mapping.LOG
...
INSERT INTO MG_PRODUCT_MAPPING SELECT * FROM xxxx;
