-- Populate MG_CASE_ERROR_LOG from source.
-- Spool: db/logs/sql/01_populate_mg_case_error_log.LOG (path is relative to SQL*Plus cwd;
...
-- Spool Log File
SPOOL &spool_log_dir./01_populate_mg_case_error_log.LOG
...
--INSERT INTO MG_CASE_ERROR_LOG SELECT * FROM xxxx;
